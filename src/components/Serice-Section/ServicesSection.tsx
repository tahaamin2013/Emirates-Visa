  ...
  return (
    <div className=" flex flex-col justify-center items-center">
      ...
      <div className=" flex flex-col items-center mt-[-30px] gap-3 lg:flex-row">
        <div className="bg-white w-[350px] lg:w-96 text-center p-[27px]">
        ...
        <div className="bg-white w-[350px] lg:w-96 text-center pb-12 p-[27px] ">
          <p className="text-md text-gray-600">
        ...
        <div className="bg-white w-[350px] lg:w-96 text-center p-[35.2px] pt-[32px] pb-[43px]">
          <p className="text-md text-gray-600">
