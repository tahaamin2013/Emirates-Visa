...
<div className="bg-[#efefef] rounded shadow-md p-6 xl:w-fit xl:h-fit w-full h-full">
  ...
  <div className=" flex flex-col lg:flex-row gap-3 mb-9 mt-9">
    ...
    >
      <p className="text-xl mt-4 mb-2">
        <Image src="/Mansvg.svg" alt="Card" width={60} height={60} />{" "}
      </p>
      <p className="text-center text-sm">
        Picture / <br /> Headshot
      </p>
      <hr className=" border-b-[#e90000] border-[3.4px] border-transparent w-[100px] mt-3 rounded-full mb-3" />
      <p className="text-[12px] mt-3 w-44">
        Clear passport style color photo or a selfie with white
        background.
      </p>
    </div>
    ...
    >
      <p className="text-xl mt-6 mb-4">
        <Image src="/linessvg.svg" alt="Card" width={60} height={60} />{" "}
      </p>
      <p className="text-center text-sm">
        Personal <br /> Details
      </p>
      ...
      <p className="text-[12px] mt-3 w-48">
        Name and contact details so we can facilitate your application.
      </p>
    </div>
    ...
    >
      <p className="text-xl mt-5 mb-3">
        <Image src="/nationality.svg" alt="Card" width={70} height={70} />{" "}
      </p>
      <p className="text-center text-sm">
        Additional <br /> Documents
      </p>
      <hr className=" border-b-[#e90000] border-[3.4px] border-transparent w-[100px] my-4 rounded-full" />
      <p className="text-[13px] mt-3 w-48">
