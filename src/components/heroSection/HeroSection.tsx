...
const HeroSection = () => {
  ...
  return (
    <>
    <div className={` overflow-hidden bg-cover bg-no-repeat bg-center ${styles.heroSection}`}>
        ...
        <div className={`text-white mt-[80px] ${styles.style}`}>
            <div className="content">
              <div className="text-container text-[22px]">
                ...
                <p className={`hidden second ${styles.paragraphs}`}>The fastest way to get your Emirates Visa approval</p>
